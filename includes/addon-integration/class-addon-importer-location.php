...
if ( ! class_exists( 'RealEstate_Sync_AddOn_Importer_Location' ) ) {
    class RealEstate_Sync_AddOn_Importer_Location extends RealEstate_Sync_AddOn_Importer_Properties {
