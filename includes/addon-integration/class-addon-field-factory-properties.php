...
if ( ! class_exists( 'RealEstate_Sync_AddOn_Property_Fields' ) ) {
    class RealEstate_Sync_AddOn_Property_Fields {
        ...
        public function advanced_options() {
            $advanced_options = array(
                ...
                $this->add_on->add_field( 'property_agent_or_agency', 'If no Agent/Agency found, RealEstate Sync will auto-create a new:', 'radio', array(
                    'estate_agent' => 'Agent',
