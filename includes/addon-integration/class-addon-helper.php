...
if ( ! class_exists( 'RealEstate_Sync_AddOn_Helper' ) ) {
    
    class RealEstate_Sync_AddOn_Helper {
        ...
        public function get_post_type() {
            ...
            **/
            ...
            $imports_table = $wpdb->prefix . 'realestate_sync_imports';
        ...
        public function fetch_handler() {
            ...
            // WP All Import dependency removed for RealEstate Sync integration
            return false;
            ...
            $handler = new realestate_sync_Handler();
            return $handler;
