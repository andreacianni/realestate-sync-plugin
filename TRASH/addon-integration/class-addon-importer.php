...
if ( ! class_exists( 'RealEstate_Sync_AddOn_Importer' ) ) {
    class RealEstate_Sync_AddOn_Importer {
		...
		public function import_property_data( $post_id, $data, $import_options, $article ) {
			$importer = new RealEstate_Sync_AddOn_Importer_Properties( $this->add_on );
        ...
        public function agents( $post_id, $data, $import_options, $article ) {
			$importer = new RealEstate_Sync_AddOn_Importer_Agents( $this->add_on );
