            ...
            <div class="row g-4 align-items-start rs-monitor-columns">
                <div class="col-12 col-xl-7">
                    <div class="rs-monitor-panel rs-monitor-panel--technical">
                        ...
                        <table class="table table-sm table-bordered mb-0 rs-monitor-table rs-monitor-table--technical">
                            <tbody>
                                <tr>
                ...
                <div class="col-12 col-xl-5">
                    <div id="queue-import-functional-stats" class="rs-monitor-panel rs-monitor-panel--functional rs-hidden"></div>
                </div>
            </div>
        </div>
