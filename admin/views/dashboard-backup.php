...
<?php if ($last_import): ?>
    ...
    <?php if ($import_in_progress): ?>
        ...
        updateProgress: function(progress) {
            ...
            $('#import-progress-bar, #import-progress-bar-status').css('width', percentage + '%');
            $('#import-progress-text, #import-progress-text-status').text(
    ...
    // Testing functions for Import Status tab
    var testing = {
        ...
        createPropertiesFromSampleV3: function(e) {
            ...
            dashboard.showAlert('Creazione properties da sample v3.0 in corso...', 'warning');
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        dashboard.showAlert('Errore creazione properties v3.0: ' + response.data, 'error');
                    }
                },
                error: function() {
                    dashboard.showAlert('Errore di comunicazione con il server', 'error');
        ...
        cleanupProperties: function(e) {
            ...
            dashboard.showAlert('Cancellazione properties in corso...', 'warning');
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        dashboard.showAlert('Properties cancellate: ' + response.data.deleted_count + ' properties eliminate', 'success');
                        testing.refreshPropertyStats();
                    } else {
                ...
                complete: function() {
                    $('#cleanup-properties').prop('disabled', false).html('<span class="dashicons dashicons-trash"></span> Cleanup Database');
                }
            });
        },
    ...
    // Initialize the complete 3-tab system
    tabSystem.init();
